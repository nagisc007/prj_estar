...
def sc_visited(w: wd.World):
    ...
    return w.scene("訪問者",
            ...
            kyoko.look().d("彼", "$n_shotaは立ち上がると$childに毛糸を渡し",
                "階段を降りる。",
                "$meの前に立つとほぼ目線の高さが同じだ。",
                "黒目の大きなとても澄んだ瞳がぼんやり照らされ", "じっと向けられた"),
...
def sc_hisvisit(w: wd.World):
    ...
    return w.scene("彼の再訪",
            ...
            kyoko.think("結局あれから$saitoとメールアドレスを交換して",
                "形だけは友だちということになった。",
                "少しだけ心が軽いのは彼女も$meと同じくガラケーだったことだ。",
                "ＬＩＮＥのＩＤ交換を",
                "と笑顔で言い出されることに対していちいち「ガラケーなんで」と返すことに",
                "最近気が重い"),
            ...
            kyoko.think("何度そう思って意識を取り戻そうとしても",
                    ...
                    "腕も足も感覚がなくなって",
                    "$meは沈んでいった"),
            w.tag.symbol("『" + cnf.TITLE["chap3"] + "』に続く"),
            )
