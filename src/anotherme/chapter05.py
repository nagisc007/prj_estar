...
def sc_meetmatsu(w: wd.World):
    ...
    return w.scene("松本と出会う",
            ...
            matsu.talk("$meは$kyokoが誰と付き合おうと気にしないが",
...
def sc_hisvanish(w: wd.World):
    ...
    return w.scene("彼はもういない",
            h.deal("二階の一室のドアを",
                "彼の父親が開けてくれている。",
                "鍵が掛けられていて",
                "ドアの前にぶら下がったひらがなの『しょうたろう』プレートが揺れる"),
            dad.talk("妻はこの時期になるといつも体調を崩してしまってね。",
                "秋田の実家に帰っているところなんだ"),
            h.look("彼の背中には$meが想像することも難しい時間の重みが伸し掛かっているのだろう"),
            h.look("プレートの揺れが収まり", "鍵が開いた。",
                "ドアノブもプレートも全然埃塗れになっていないことが",
                "彼の中ではまだ$shotaが生きているのだろうと思わせた"),
            ...
            h.look("当時のまま残されていると聞いたけれど",
                "本当に小学生が眠るサイズの小さなベッドとその脇の壁の一画を占拠する大きな本棚",
            ...
            h.look("鉛筆と布の筆箱", "小さな鉛筆削りもあって",
                ...
                "当然誰もいなかった"),
            h.move("ベッドの先にはサッシの窓があって",
                "ベランダになっていた。", "ここから紐を伝って降りたと話していたけれど",
                "二階とはいえ結構高さがある"),
            h.look("部屋に戻ると", "$meは壁を占拠する大きな本棚の前に立つ"),
            h.look("その棚の一画", "父親が手を入れたのか",
                "小さな本立てによって区切られていて",
                "そこに遺影としてなのか",
                "小さな彼の写真が飾られている。",
            ...
            child.talk("それって大人にならないと", "できないんだよ？"),
            shota.talk("それじゃあ", "せいじんして大人になったら", "$meとけっこんしてくれる？"),
            h.think("そうだった。",
...
def sc_alone(w: wd.World):
    ...
    return w.scene("今日子ひとり",
            ...
            h.look("でもそれは本当に気がしただけで",
                "何も見えない。", "ちゃんと空席で「すみませんね」とお婆さんがやってきて埋めてしまった"),
            h.think("$meは紛れもなく独りだ"),
...
def sc_goodbyeanothers(w: wd.World):
    ...
    return w.scene("さよならわたし",
            ...
            h.think("$meにとって$childや$studentの存在は",
                ...
                "世界からの贈り物だったのかも知れない"),
            h.look("大通りに出ると急に車の音や人の声がよく響いてきて",
...
def ep_truth(w: wd.World):
    return (w.chaptertitle("真実と真相"),
            sc_hismanshion(w),
            sc_hisvanish(w),
                w.kyoko.deal(w.info("vanish"), w.shota),
            sc_alone(w),
            )
