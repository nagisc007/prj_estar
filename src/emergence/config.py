...
CHARAS = (
        # main
        ("miyako", "斎賀,美耶古", 16, "female", "高校生", "me:わたし:aya:彩:S:美耶古:kirimura:霧村"),
        ("kirimura", "霧村,豊", 35, "male", "教師", "me:俺:miyako:斎賀:aya:千覧"),
        # sub
        ("aya", "千覧,彩", 16, "female", "高校生", "me:私:miyako:美耶古"),
