...
def sc_redmoon(w: wd.World):
    ...
    return w.scene("赤い月",
            ...
            miyako.deal("家族旅行でわざわざそれを見るツアーに申し込んだのだと",
                "年末に嬉しそうに話してくれたことを思い出す").omit(),# NOTE:思い出す
            miyako.talk("でも結局自分の写真は一枚も送ってこないじゃない。",
                "あのばーか"),
            miyako.deal("ベッドの上で寝返りを打ち",
                "天井に向かってスマホを持つと",
                "ＬＩＮＥアプリを呼び出した"),
            miyako.deal("今ならひょっとすると出てくれるかも知れない",
                "という一縷の望みでコールを押した").omit(),
...
def sc_strangeman(w: wd.World):
    ...
    return w.scene("妙な先生",
            ...
            miyako.move("ひんやりとした廊下の上",
                "紺色のセーラー服の長めのスカートを蹴り上げるように歩きながら",
                "$Sは教務棟の二階", "視聴覚室脇を通り過ぎる"),
            ...
            miyako.look("生徒の作品だろうか。",
                ...
                "無数の油絵が散乱していた"),
            miyako.look("ただよく見るとそれらはどれもが目玉がギョロリと飛び出たような人ならざるモノの怪奇画で",
                "中には蜘蛛や猿", "半魚人のようにも見える異形が描かれている"),
            miyako.talk("臭っ……").omit(),
            miyako.feel("鼻を突くシンナーのような臭いに$Sは思わず口元を押さえたが",
                "その足元に転がっている赤や青で汚れた白衣を来た男性を見つけて思わず声が漏れた"),
            miyako.look("けれど口を押さえたのはそれだけが理由ではなかった。",
                "赤や青で汚れた白衣を着た男性が足元に転がっていたからだ").omit(),
            miyako.talk("ひゃっ！"),
            kiri.ask("なんだ？"),
            ...
            miyako.talk("ちょっと飲み物買って来るんで").omit(),
            miyako.move("何とか上半身を起こした先生を見てそう言うと",
                "$Sは一番近い階段下の自販機まで走った").omit(),
            )
...
def sc_herdrawing(w: wd.World):
    ...
    return w.scene("彼女の絵",
            ...
            miyako.talk("何バカなこと言ってるんですか"),
            miyako.look("背もたれのない木椅子に座り",
                "猫背で肩を揺らして笑う$kirimuraの姿に", "$Sは溜息がちにペットボトルのお茶を飲んだ"),
            ...
            kiri.talk("彼女は体育祭後に入部してそれから約二ヶ月掛けてこの絵を仕上げ",
                "それ以来部活動には顔を出さなくなった"),
            ...
            miyako.look("$kirimuraはじっと黙って話に耳を傾けながら",
                "ペットボトルのお茶の残りを喉へ流し込む"),
            miyako.talk("実は彼女の母親がある宗教をやっているという噂が流れて",
            ...
            miyako.talk("$meもいじめが原因とは考えていません。",
                ...
                "ニ学期になって学校にほとんど来なくなると",
                "ＬＩＮＥもあまり答えてくれなくなりました"),
            kiri.ask("それは$miyakoとの間で何かあったんじゃないのか？").omit(),
            ...
            miyako.look("まるで赤い墨で描かれた水墨画にも見える$ayaの絵は",
                    "じっと見ているうちに月が溶け出してそれが糸を引き流れ落ちた先で手を上げる女性を形作っているようにも見える"),
            kiri.talk("月食というのは昔から凶兆として捉えられてきた天文現象だが",
                    "ところによっては一度死んで新生する",
                    "つまり生まれ変わりの象徴として考えられてきたんだ"),
            miyako.ask("生まれ変わり？"),
            miyako.look("その言葉で徐にスマートフォンを取り出すと",
                    "$Sは画面に彼女から送られた月食の写真を出して先生に見せた"),
            miyako.talk("実は彼女",
                    "何度かＬＩＮＥで言ってたんです。",
                    "『新しい自分に生まれ変わりたい』って。",
                    "先生は何か心当たりがあったりしませんか？"),
            ...
            kiri.talk("$meはそこまで部活に顔を出してた訳じゃないが",
                    ...
                    "寧ろあいつは自分のことが意外と気に入っているんじゃないかと思ってたくらいだ").omit(),
            miyako.talk("そうです。",
                    "$meもそう思うんです。",
                    "だからこそどうしてって").omit(),
            kiri.ask("なあ$miyako。",
...
def sc_gotoherroom(w: wd.World):
    ...
    return w.scene("彼女の部屋に",
            ...
            miyako.look("三年ぶりに入った$ayaの家は電気を点けていないからか",
                "不気味な薄暗さが続いていた。",
...
def sc_mymind(w: wd.World):
    ...
    return w.scene("私の気持ち",
            ...
            miyako.look("$Sが体を丸めたままゆっくりと目を開けると",
                "殆ど光のない",
                "海の底のような場所で",
                "自分がどんどん落ちているのだと分かった"),
            ...
            miyako.deal("$Sの方は足をぶらつかせるだけで",
                "昔からあまり揺らすのは好きじゃなかった"),
            aya.talk("$meはこの服が", "嫌い"),
            miyako.look("彼女はそう言って胸元の赤いタイをぎゅっと握りしめる"),
            ...
            miyako.look("だが手はスマートフォンを握り締めていて",
                    "画面は激しく明滅している"),
            kiri.talk("おい！",
                    "$miyako！",
                    "聞こえてるか？"),
            ...
            miyako.look("目の前の$ayaに似た真っ赤な何かと",
                    ...
                    "$Sは小さく息を吸い込む"),
            miyako.talk("違う"),
            kiri.talk("そうだ。", "それでいいぞ$fn_miyako"),
...
def sc_rescue(w: wd.World):
    ...
    return w.scene("救助",
            ...
            miyako.look("そう言われて見せられたのは",
                "先生の掌大の節くれ立った白い蜘蛛のようなものだ"),
            miyako.deal("いや", "蜘蛛とは違う。",
                "足の数こそ多いが", "体が三つの部分に分かれている。",
                "そういうものは虫だと教わっていた").omit(),
            ...
            miyako.talk("$aya……"),
            miyako.move("$Sはふらふらと力なくベッドに近づくと",
                    "そのセーラー服を抱き上げた"),
            miyako.talk("$aya。",
                    "$me", "ずっと$ayaのことが大切だった。", "親友だと思ってた。",
                    "でも何一つ気持ちを分かってあげられていなかったんだね"),
            miyako.deal("血まみれになるのも気にせず強く強く抱き締める"),
            miyako.talk("痛っ……"),
            miyako.deal("制服のポケットにスマートフォンが入っていた"),
            miyako.look("それを取り出して見ると",
                    "$Sに向けたＬＩＮＥの画面が表示されていて――"),
            miyako.talk("ありがとう……？"),
            miyako.look("刹那",
                    "画面が黒くなり", "そこに一匹の赤い蝶が浮かび上がる"),
