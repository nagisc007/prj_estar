...
def ep_preparation(w: wd.World):
    ...
    scenes = [
            w.scene("父の死、皇帝の死",
                ...
                garneth.go("出ていく"),
                h.think("今後のこと"),
                w.albert.talk().t("殿下……").omit(),
                h.look().d("通路では装備を整えた$albertが不安そうに$heroの顔を見たが、").omit(),
                h.reply().t("部屋に戻る").omit(),
            ...
            w.scene("継承のこと",
                ...
                h.remember().d("彼は人が死ぬというのは外側の器だけが壊れ",
                    "中身である精神はまた別の世界へと旅立ち",
                    "そこに住み着くのだと教えてくれた"),
                h.think().d("完全に精神が離れてしまうまでの時間が約一日であり",
    ...
    scenes = [
            ...
            w.scene("人格の継承",
                ...
                garneth.talk().t("一説ではここは重罪人を閉じ込めておく為の地下牢だった",
                    "とも云われておりますな。",
                    "この$st_kingdomが興るまでには様々な血腥い歴史があったと聞きます。",
            ...
            w.scene("呪いの継承",
                ...
                garneth.talk().t("そうしないとお目覚めになられませんので……必要悪",
                    "というものでしょう"),
                h.ask().t("それに徐々に器の歳が若返っているようだが？"),
                garneth.talk().t("代を重ねる毎に暴走が早まっております故",
                    "強制的な器の交換が必要になりましてね"),
