...
def sc_warmingdays(w: wd.World):
    ...
    return w.scene("温かい日々",
            ...
            h.deal("一人満足そうに自作のウッドデッキに出てバーベキューで肉と野菜を焼いていた$n_hirokiは",
                "中のリビングで楽しげに笑い声を上げる妻とその妹夫婦をサッシのガラス越しに見やり",
                "その違和感に苦笑を浮かべた"),
            ...
            h.deal(w.info("子どもの話").flag()),# NOTE: 子どもフラグ
...
def sc_confab(w: wd.World):
    ...
    return w.scene("上司に相談",
            ...
            h.deal("幾らか明るい調子で$Sは答える。",
                ...
                "そのはずだと", "$Sは思っている"),
            mizu.talk("そういう風に前向きに捉えられる$hirokiは偉いな。",
...
def sc_modelingwork(w: wd.World):
    ...
    return w.scene("モデリング",
            ...
            h.look("目の前で動いてブロックを掴む機械の腕は",
                ...
                "キィ、キュゥイーン、というコンプレッサやギアの音が彼女の生活からは随分と離れたようなものに思えたが",
                "$yokoは興味深そうに頷いて見ていた"),
...
def sc_mothersletter(w: wd.World):
    ...
    return w.scene("母の手紙",
            ...
            h.deal("それでも自分宛ての手紙を取り",
                "椅子に座って黙読する"),
            h.deal("最初の一文はいつも決まって同じ言葉から始まっていた。",
                "けれどそれを目にする度に$Sは思うのだ。", "大変な最中にあっても自分のことを思ってくれた母という偉大な人間に『ありがとう』と"),
            )
