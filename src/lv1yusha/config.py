...
CHARAS = (
        ...
        # chapter1
        ("diana", "ディアナ", 27, "female", "戦士", "me:アタイ:hero:アリエル:father:オルンガ:maririn:マリリン:kult:クルト"),
        ("kult", "クルト", 25, "male", "僧侶", "me:私:hero:アリエルさん:maririn:お嬢様:diana:ディアナさん"),
        ("maririn", "マリリン", 22, "female", "魔法使い", "me:わたし:hero:アリエル:diana:ディアナ:kult:クルト"),
        ("daemon1", "アークド・ダモン", 99, "monster", "魔物", "me:オレサマ"),
