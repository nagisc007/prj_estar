...
def ep_anotherhero(w: wd.World):
    scenes = (
            w.scene("もう一人の英雄",
                w.hero.feel().d("風が",
                    "$myの内側までも吹き抜けていったかのような間だった"),
                w.hero99.talk().t("何してんだよ"),
                w.hero.hear().d("誰の声だろう。",
                    "少なくともあの魔物のものとは異なる。",
                    "もっと人間味があり",
                    "そうだ",
                    "耳馴染みのある響きを感じる"),
                w.hero.think("恐怖", w.daemon1).d("それに空気が変わっていた。",
                    "先程までの恐怖を薪にして炊き上げたような畏れは消え去っていた"),
                w.hero.behav().d("$myはゆっくりと目を開ける"),
                w.hero.look().d("そこには先程まで斧を手に立っていた紫色の魔物の",
                    "大きく二つにズレた胴体が横たわっていた。",
                    "目は開かれたままで",
                    "閉まらない口は何も言わない。",
                    "ただその丸太のような腕がいつ動き出しても不思議ではないくらいに",
                    "生命力が満ちている。",
                    "$myにはそんな風に見えた"),
                w.hero99.ask().t("その通りだ。",
                    "ヤツはまだ死んでない"),
                w.hero.hear().d("声こそ聞こえるが",
                    "辺りを見回してもその主の姿は見つけられない"),
                w.hero.ask().t("誰なんですか？"),
                w.daemon1.ask(w.hero, w.i.herosun),
                w.daemon1.talk(w.hero, "kill").t("ころして", "やる"),
                w.hero.look().d("その質問に誰かが答えた訳ではなかった。",
                    "眼前に転がる魔物の頭部が口を開いたのだ"),
                w.daemon1.talk(w.hero, "お前は死ぬようにこの世界はできている", w.flag.crackworld).t(
                    "お前は決して生きられぬ。",
                    "何故ならこの世界はそういう風に出来ているのだからな"
                    ) ,
                w.hero.ask().t("な、何なんだよ一体！"),
                w.hero.look().d("だが魔物は答えず", "ただ不気味な笑みを見せるだけだ"),
                w.hero.talk().t("ひぃ！"),
                w.hero.behav().d("$myは腰が抜けてその場に尻もちを着いた"),
                w.daemon1.talk().t("貴様は永遠にその及び腰のまま",
                    "我らから逃げ回るしかないのさ！",
                    "アッハッハ！"),
                w.hero.look().d("魔物は大口を開け", "毒色をした牙を見せつける。",
                    "その口の奥",
                    "紫色の炎の玉が徐々に大きくなり、"),
                w.hero99.talk().t("何してんだ！",
                    "死にたいのか！？"),
                w.hero.talk().t("えぁっ……",
                    "あぁ！？"),
                w.hero.do("生き延びる").d("謎の声で$myは慌てて地面を掻くようにしてその場から逃げ出す"),
                w.hero.feel().d("その頭上を魔性の炎が真っ直ぐに飛んでいき",
                    "町の防壁にぶつかった。",
                    "途端に組み上げられたブロックは真っ黒な粉になって霧散し",
                    "炎はうねる"),
                w.hero.hear().d("聴こえてきたのは悲鳴だ"),
                w.hero.look().d("何発も吐き出された魔物の炎はあっという間に城下町を混乱に陥れる。",
                        "見ている内にも次々と火の手が上がり",
                        "空から翼を持った別の魔物が次々に落下しては人々を襲った"),
                w.hero.talk().t("何なんだ……一体何なんだよ！"),
                w.hero99.talk().t("現実だよ。",
                        f"とにかくあのクルトって奴の死体から{w.warpwing.name}を奪って使え！",
                        "そうしないとここでお前はゲームオーバーだぞ！"),
                w.hero.think().d("頭の中に響く謎の声が焦っていることだけは何とか理解できた。",
                        "ただ目を開いたまま絶命している$kultの上着に手を入れろ",
                        "ということを平然と言ってのけるその神経は全然理解しようとは思わない"),
                w.hero.look().d("それでも振り向けば己の別れた下半身に手を伸ばしている紫の魔物の姿がある。",
                        "あれが元に戻れば次こそは殺されるだろう"),
                w.hero.talk().t("クソがぁ！"),
                w.hero.go().d("声を上げてとにかく走った"),
                w.hero.do().d("ごめん",
                        "と心の中で手を合わせると$kultの神官衣の内側を探る。",
                        "幾つかの薬草や魔法石があったが",
                        f"$myはそれらに目もくれずにとにかく{w.warpwing.name}だけ抜き取ると、"),
                w.hero99.talk().t("使え！"),
                w.hero.reply().t("言われなくても！"),
                w.hero.do().d(f"小さな翼を空に放り投げる"),
                w.daemon1.talk().t("逃がさんぞ！"),
                w.hero.look().d("自分の体が空にふっと浮かび上がるとほぼ同時だった。",
                        "魔物が五体満足に復活し",
                        "その斧を今し方まで$myがいた場所へと振り下ろした"),
                w.hero.look().d("地響きと土煙が上がり",
                        "その場から放射状に割れ目が広がる"),
                w.hero.be().d("けれどその瞬間にはもう",
                        "$myの体は光の衣に包まれて空間から消え去ってしまっていた"),
                w.hero.be(w.i.massacre),
                w.hero.go("runaway"),
            ...
            w.scene("世界改変",
                w.hero99.ask().t("おい"),
                w.hero.come(w.stage.field1.insided("洞窟")).d("また頭の中で声がする"),
                w.hero99.ask().t("いい加減にしないと$motherが起こるぞ？"),
                w.hero.hear().d("$motherが！？"),
                w.hero.look().d("その言葉で飛び起きた"),
                w.hero.talk().t("ここ……って家じゃないよね"),
                w.hero.look().d("薄暗い。",
                    "遠くに光源が見えたが",
                    "どうやらどこかの横穴にでも入って寝ていたらしい"),
                w.hero99.talk().t("たく",
                    "レベル１とはいえ本当に情けない面だな"),
                w.hero.look().d("続いて",
                    "目元を細めて自分を覗き込む髭面の男の存在に気づいた"),
                w.hero.ask().t("だ、誰！？"),
                w.hero99.reply().t("$meは$heroだ"),
                w.hero.think().d("その声こそさっきまで頭の中に響いていたものだったが",
                    "相変わらず話していることが理解できない"),
                w.hero99.talk().t("まあ今の$heroに理解できないのも無理ないさ。",
                    "簡単に説明するとだな……$meは$heroがレベル９９になった$heroだ"),
                w.hero.ask(w.hero99).t("レベル９９？"),
                w.hero99.reply(w.hero, "レベル９９").t("そうだよ。",
                    "レベル９９。",
                    "つまりもうこれ以上は強くなれません",
                    "ていう上限値だな。",
                    "$me様最強ってことだ"),
                w.hero.look().d("意味不明なことを言って笑う男は",
                    "背中に大きな剣を背負い",
                    "不思議な生地のマントを羽織っているところからして",
                    "明らかに旅の者",
                    "それも傭兵や戦士といった類の人種だと思えた"),
                w.hero.think().d("ただ",
                    "町中で出会ったあの長身の男とは違う。",
                    "どこか",
                    "そう",
                    "$dadに似た雰囲気が彼からは感じられた"),
                w.hero.ask(w.i.level).t("あの"),
                w.hero99.reply().t("何だ？"),
                w.hero.ask().t("せめて名前くらい教えてくれないんですか？"),
                w.hero99.reply().t("名前なあ……だってさ",
                    f"お前は$meが{w.hero.name}だって言ったところで信じないだろ？"),
                w.hero.think().d("どうして自分の名前を彼が名乗るのだろう。",
                    "怪しい男だとは思うが",
                    "自分に危害を加えないだろうという妙な安心感もある"),
                w.hero.ask().t("じゃあ何て呼べばいいんですか？"),
                w.hero99.reply().t("そうだな……面倒だからクックで良いよ。",
                    "９９だからクック。",
                    "どこかの船長みたいだろ？"),
                w.hero.think().d("冗談のつもりなのだろうか"),
                w.hero.think().d("けれど今の$myはそれに愛想笑いであっても返すことができなかった。",
                    "とてもそんな心境にはなれない。",
                    "何故なら大切な仲間を全て",
                    "一瞬にして失ったからだ"),
                w.hero99.talk().t("いいか。",
                        "これから$meは大事な話をする。",
                        "おそらくこれはこの世界では言葉にならないかも知れないが",
                        "それでも出来る限り話しておいてやる"),
                w.hero.ask().t("それはいいんですけど",
                        "どうして$meのことを助けてくれるんですか？"),
                w.hero.look().d("目の前の男が何を考えているのか分からない。",
                        "けれど命を救ってくれたのは確かだ。",
                        "それに言葉の意味は分からなくても",
                        "自分の為に言ってくれていることくらいは$myでも理解できた"),
                w.hero99.talk().t("もう間もなく再び$meの姿は消える"),
                w.hero.ask().t("え？"),
                w.hero99.talk().t("そして$heroに対してしてやれることはほぼ無くなる"),
                w.hero.look().d("意味は理解できない。",
                        "しかし疑問を挟むことなく$myは真剣に彼の言葉に意識を集中した"),
                w.hero99.talk(w.i.worldsecret).t("実はこの世界は魔王によって改変された。",
                        "本来であれば$heroは普通にレベルを上げて頼りになる仲間たちと共に魔王退治をすることになっていたはずだ。",
                        "だがもうそれは望めない"),
                w.hero.think().d("世界が改変された。",
                        "その言葉だけが何故か$myの頭の中で何度も反響する"),
                w.hero99.talk(w.deflag.crackworld).t("何故ならこの世界で奴を倒すことが出来た唯一の存在である$heroが",
                        "どんなに努力したところで絶対に討伐可能レベルに達しないようにしてしまったからだ"),
                w.hero.ask().t("だからそのレベルって何なんですか！？"),
                w.hero99.reply().t("レベルとは強さを数値で表現したものだ。",
                        "そして$heroはレベル１",
                        "つまり最弱の状態から永遠に変わらない。",
                        "どんなに経験を積んでも",
                        "どれほどの魔物を倒しても",
                        "決してレベルは上がらないんだ"),
                w.hero.think().d("それは$dianaたちから聞いた話と全然違っていた。",
                        "仮に$lv99が話していることが事実だとしたら",
                        "いや",
                        "事実だからこそ",
                        "どれほど修練を積んでも$bazemには敵わなかった。",
                        "筋が悪いとか",
                        "覚えが悪いとか",
                        "センスがないとか",
                        "そんな事情じゃなく",
                        "どんなに努力を重ねても決して強くならないようにされていたのだ"),
                w.hero.talk().t("何でそんなこと……"),
                w.hero99.talk().t("奴が……いや",
                        "奴らが気づいたからだよ。",
                        "どんなに強い魔王になっても最後には勇者という名の人間の手によって葬り去られる。",
                        "そういう運命を変える為には強い魔物を生み出したり",
                        "町を滅ぼしたりするのではなく",
                        "世界の仕組みを変えてしまうことだ",
                        "とな"),
                w.hero.know(w.hero99, w.i.worldsecret),
                w.hero.have(w.hero99, w.i.coop),
                w.hero.ask().t("じゃああなたの存在は何だっていうんですか？",
                        "どうしてレベル９９になった$meがいるんですか！？"),
                w.hero.think().d("もう二度と強くなれない"),
                w.hero.think().d("その事実は後頭部を殴られるよりもずっと痛くて",
                        "今ここで泣き出してしまいたくなったが",
                        "それ以上に今目の前にいるレベル９９だという自分自身らしき存在に",
                        "嫉妬心が芽生えてしまった"),
                w.hero99.reply().t("どんな完璧に見える仕組みにもな",
                        "絶対に穴がある。",
                        "$meは今その穴を使ってお前に話しかけているんだ。",
                        "だがこれもすぐ使えなくなる。",
                        "気づかれたら",
                        "$meは消えるしかないんだ"),
                w.hero.look().d("そう口にした傍から彼は辺りを見回し始める"),
                w.hero.ask().t("$lv99？"),
                w.hero99.reply().t("悪いな。",
                        "どうやらもう時間がない"),
                w.hero.talk().t("そんな！"),
                w.hero99.talk().t("アリエル。",
                        "お前は弱い。",
                        "だが決して心を折るな。",
                        "打開する為の道は必ずどこかに隠されている"),
                w.hero.think().d("無理だ。",
                        "と叫んでしまいたかった"),
                w.hero99.talk().t("諦めないことと",
                        "常に状況をよく観察し",
                        "二手三手先まで考えろ。",
                        "強くなれない$heroの唯一の武器は",
                        "死なないということだけだ"),
                w.hero.ask().t("え……"),
                w.hero99.be("vanish").d("だがその疑問を挟む前に",
                        "彼の姿が見えなくなる。",
                        "目の前から消えてしまったのだ"),
                ...
                w.hero.talk().t("$lv99さん？"),
                w.hero.hear().d("けれど何度呼びかけても彼の声はもう$myの耳には届かなかった"),
                w.hero.talk().t("死なない？",
                        "どういうことなんだ……"),
                w.hero.behav().d("$myは立ち上がる"),
                w.hero.go().d("自分の足が無事なことを確認すると",
                        "明かりの方へと歩いていった"),
                w.hero.look().d("光源の先はおそらくどこかの山か森に繋がっているはずだ"),
                w.hero.think().d("魔王退治を王様から頼まれた"),
                w.hero.think().d("その為に酒場で仲間を集めた"),
                w.hero.think().d("試練の塔に行けと言われて町の外に出たら",
                        "仲間が魔物に皆殺しにされた"),
                w.hero.think().d("おまけに自分まで殺されそうになり",
                        "そこをレベル９９だというもう一人の自分によって助けられた"),
                w.hero.think().d("何がなんだかよく分からない"),
                w.hero.think().d("考えれば考えるほど",
                        "ただ泣きたくなった"),
                w.hero.look().d("何とか入り口らしき場所までやってきて",
                        "そこから一歩を踏み出す"),
                w.hero.look().d("見れば雪が掛かる高い峰がどこまでも視界に入ってきて",
                        "見上げた空は分厚い黒雲がしっかりと塞いでいる"),
                w.hero.talk().t("何なんだよ！",
                        "ここはどこなんだよ！"),
                w.hero.hear().d("けれど誰も答えず",
                        "ただ寂しく響いて消えていくだけだ"),
                w.hero.look().d("改めて足元に視線を向けると",
                        "大地もない。",
                        "道もない。",
                        "木や草も見えない"),
                w.hero.look().d("ただただ崖が続いていた。",
                        "とても下りていくなんて無理だとしか思えない",
                        "奈落へと続く岩盤が続いていたのだ"),
                w.hero.ask().t("なあ……$lv99さん。",
                        "ほんとに$meは死なないんだよね？"),
                w.hero.hear().d("答えはなかった"),
                w.hero.look().d("洞窟を奥へと戻る。",
                        "そうしてみたところで何か解決するだろうか"),
                w.hero.think().d("それならいっそ",
                        "このまま落ちてしまった方が楽になれる"),
                w.hero.think().d("そう考えた$myは",
                        "思い浮かべた人々に対して",
                        "ごめんなさい",
                        "と謝り",
                        "一歩を虚空へと踏み出した"),
                w.tag.symbol("To be continued"),
                ),
            )
