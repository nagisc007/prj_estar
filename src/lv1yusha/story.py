...
def ep_heros_sun(w: wd.World):
    scenes = (
            w.scene("城へ向かう",
                ...
                w.hero.look(w.stage.town).d("中央通りに出る",
                    "と開店準備をしている人や仕入れ客で商店街にはそれなりに人出がある。",
                    "ただやはり入ってくる物が少ないのか",
                    "どの店の人も表情に陰りがあった"),
                ...
                w.hero.look().d(f"{w.anabel.name}は恥ずかしそうに暫くf{w.hero.name}のことを見つめていたが、"),
            ...
            w.scene("知らされる事実",
                ...
                w.cornel.talk().t("当初は内内で処理をしようと考えていたのだが",
                    ...
                    "外は凶暴な魔物で溢れているとな"),
                w.hero.think().d("それは$na_bazemから聞いていた以上のものだった。",
