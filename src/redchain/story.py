    ...
    scenes = [
            ...
            w.scene("同業者の現在",
                ...
                ma.think().d("何故彼女の名前を出しただけで女性は気を悪くするのだろう。",
                        ...
                        "引退からニ十年が過ぎてもこれだけ影響を残している$hidekoという女性のことを一人の人間として",
    ...
    scenes = [
            w.scene("喫茶店にて",
                ...
                manager.talk().t("何を勉強してきたのか知らないが$meにとって彼女",
                    "$hidekoというのは将来この日本を代表する女優になる逸材だと今でも思っているし",
                ...
                manager.talk().t("……あんたも$hidekoにやられた人間なんだな。",
                        "これで安心して案内できるよ"),
            ...
            w.scene("アイドル時代のこと",
                ...
                ma.look().d("辛うじて芸能事務所らしさを感じさせるアイドルや映画のポスターが壁に貼られている程度で",
                    "事務員すらいなくて何とも物悲しい。",
                    "聞いていた話では$hidekoが所属していた頃には都内の一等地に持ちビルがあったというから",
                ...
                ma.think().d("$hidekoにとってのそれは何だったのだろうかとも", "考える"),
            ...
            w.scene("元マネージャー",
                ...
                ma.talk().t("えっと$na_managerさんから$hidekoのアイドル時代のマネージャーだったと聞いたのですけれど"),
                ma.look().d("名刺を胸ポケットに仕舞いながら尋ねたが",
                    "彼は小首を傾げてしばらく考え込んでから",
                    "別の名前を口にする"),
                owner.ask().t("それって$h_idolのことだよね？",
                    "$i_idolnameの"),
                ...
                ma.ask().t("それでお尋ねしたいのは$hidekoのアイドル時代についてなんですが"),
                ma.think().d("まただった"),
                ma.look().d("彼女のことを$hidekoと呼んだ途端に表情が険しくなる"),
                owner.talk().t("そんな名前の女は知らない。",
                        "$meが知ってるのはね",
                        "$i_idolnameで活躍していた$h_idolだけだよ"),
                ...
                ma.think().d("暫く待ってみたが何も話し出してくれる様子がないので",
                        "資料には全然なかったそのアイドル時代の$hidekoについて尋ねてみる"),
                ma.ask().t("その$h_idolさんですが",
                ...
                ma.hear().d("小さな舌打ちだった"),
                ma.look().d("それを聞いた時に彼が$hidekoではなく$h_idolという名前に拘りを持っている理由の欠片が掴めたような気がした"),
                ma.think().d("名前というものは彼女たちにとって自分そのものなのだろう。",
                        "顔や出演した作品に番組", "出した曲や立った舞台",
                        "実際にイベントやライブで対面したお客さんたちとの関係性も大事だが",
                        "大多数の人間にとっては彼女というのは$hidekoであり$h_idolなのだ。",
                        "それは今でも$shopownerの中で彼女というのは$h_idolであるように",
                        "$managerや$coworkerにとっては$hidekoなのだろう"),
                ma.ask().t("その$h_idolさんはあなたが見つけられたんですか？"),
                ...
                owner.talk().t("この子は一体何なんだろうって",
                        ...
                        "とにかく危ない気がして",
                        "それでつい事務所に連れて帰ったんだ"),
                ma.look().d("アイドルとしての$hidekoを語る姿は",
                        "先程までとは別人だった。",
                ...
                ma.think().d("仮にそれが事実だったとすれば",
                        "$hidekoはあの映画の女性と同じようにシングルマザーとして自分の子を育てながら生きた",
                        "ということだろうか"),
                ma.think().d("だとしても",
                        "どういう経緯であの町に流れ着いたのか",
                ...
                ma.look().d("準備されていたＤＶＤの中には$hidekoの出演作なんて当然無く",
                        "何となく写真から想像した$hidekoに似た女優のアダルトな作品を借りて",
                        "彼女の人生を想像しながら眠りに就いた"),
                ma.look().d("眠る前にメールを確認したが",
                        "$na_tanabeからは何の言葉もなく",
                        "$na_mikiにもう一日東京で調べる旨を送っておいた。",
                        "すぐに返ってきたメールに驚きながらも許可は既に$na_tanabeから貰ってあると書かれていて",
