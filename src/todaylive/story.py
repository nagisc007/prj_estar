...
def sc_ruinworld(w: wd.World):
    ...
    return w.scene("荒廃した町",
            ...
            ito.talk().t("わ、$meも", "まだちゃんと生きてます！").omit(),
...
def sc_towertown(w: wd.World):
    ...
    return w.scene("鉄塔のある町",
            ...
            ito.think().d("少しくらいは楽しいかも知れない",
                "という思いがなかったとは言わないけれど",
                "自分が何も考えていなかったのだと現実がしっかり教えてくれた").omit(),
            ito.think().d("そんな状況でも帰る気にならなかったのは",
...
def sc_inthetower(w: wd.World):
    ...
    return w.scene("鉄塔にて",
            ...
            ito.ask().t("彼の生存報告を聞く為だけに",
                "$meはいつも生きてるんです！").omit(),
            ito.think().d("それは告白にも近い$meの掠れ声だった").omit(),
...
def sc_histalk(w: wd.World):
    ...
    return w.scene("彼の話",
            ...
            ito.look().d("その言葉に$meは呆然と立ち尽くしたまま",
                    "彼によって離されたドアがゆっくりと閉じるのを見つめていた").omit(),
            ito.look("ボロ小屋"),
            ito.look("ドラム缶風呂"),
            shima.deal("料理"),
            shima.talk(w.i.george_gone),
            ...
            ito.look().d("建てられていた全てのビルが倒れてしまった訳ではなかったけれど",
                "目に映るものはどれも",
                "真っ直ぐに立っていなかった。",
                "彼は地盤そのものから傾いたのだと言った").omit(),
            ito.think().d("そんな状態で救助活動もままならず",
                "互いに手を取り合って生き抜くしかなかった",
                "というのも$meたちと同じだった").omit(),
            ito.think().d("ただ彼は言う").omit(),
            shima.talk().t("それでもある男がいなかったら",
                "みんなバラバラになっていただろう").omit(),
            ito.look().d("ほどなくして",
...
def story(w: wd.World):
    return (w.maintitle("生存報告、今日もわたしは生きてます"),
            ep_intro(w),
            ep_towerplace(w),
            ep_hisreport(w),
            )
