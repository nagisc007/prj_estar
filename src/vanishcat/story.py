...
def sc_catlife(w: wd.World):
    ...
    return w.scene("猫の居る生活",
            ...
            h.look("真っ白なソファの上に", "雉色をした猫が気怠そうに前足に顎を載せて目を伏せている"),
            ...
            h.think("それならそれで構わない。", "ただ目の届く範囲で", "穏やかに居てくれるだけで良い"),
            h.deal("空調の温度を一度下げ",
                "一息入れようと席を立つ"),
            h.look("ソファの背には斜めに引っかき傷が付いていて", "それはおそらくこれからも少しずつ増えていくのだろうが",
                "彼女のことを考えると新しく買い換えるのもどうなのだろうか", "となかなか踏ん切りが付かない。",
            ...
            h.think("だからこそ意図しないタイミングでこうして彼女が只のロボットであることを認識させるのは止めて欲しいところだが",
                "開発者の$kiethにはそれを譲ろうという考えは微塵もなかった"),
            kisa.talk("ロボットであることを捨てさせてはいけない……か"),
            h.deal("彼の言葉を思い出し", "改めて彼女に視線を向けたが",
...
def sc_lostcat(w: wd.World):
    ...
    return w.scene("猫のいない家",
            ...
            h.deal("一月ほど殆ど会社に泊まり込みで何とかベータ版の提出は間に合わせたが",
                "叩いた先からバグが噴出して", "正直もう誰の手にも負えない状態だった"),
            h.deal("それでもやっと一日の休みを手に入れて我が家へと疲れた体を運んでくる"),
            kisa.talk("$ary？", "どこだ？"),
...
def sc_brokencat(w: wd.World):
    ...
    return w.scene("壊された猫",
            ...
            h.deal("すぐに電車を乗り継いで臨海公園駅に向かう。",
                ...
                "到着するまでに携帯電話で$kiethと幾つかメールのやり取りをした"),
            h.deal("改札を出て階段を駆け下りる"),
            h.look("ブロックが敷き詰められた駅前広場にはベビィカーを押す女性やカップルらしき男女が目に付いたが",
            ...
            h.think("結局自律した自由な存在を求める先には", "そんな歪《いびつ》さを準備しないといけないのかも知れない"),
            ...
            h.think("けれどそれは仕方のないことだ。",
                ...
                "所詮は造りものでしかない"),
            h.deal("$kiethはこうなることも踏まえて『ロボットはロボットらしさが大切だ』などと言ったのだろう"),
...
def sc_vanishing(w: wd.World):
    ...
    return w.scene("消える猫",
            ...
            h.deal("納得はいかなかった$Sだったが", "それでも無限に代用のボディを用意できる訳ではなかったから",
