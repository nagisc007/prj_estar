# -*- coding: utf-8 -*-
"""Test: the understander
"""
import unittest
from storybuilder.builder import testutils as utl
from src.bokurano.story import world, story, story_baseinfos, story_outlines
from src.bokurano.config import THEMES, MOTIFS


_FILENAME = "bokurano.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The understander")
