# -*- coding: utf-8 -*-
"""Test: The disliked you
"""
import unittest
from storybuilder.builder import testutils as utl
from src.disliked.story import world, story, story_baseinfos, story_outlines
from src.disliked.config import THEMES, MOTIFS


_FILENAME = "disliked.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The disliked you project")
