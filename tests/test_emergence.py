# -*- coding: utf-8 -*-
"""Test: The red emergence
"""
import unittest
from storybuilder.builder import testutils as utl
from src.emergence.story import world, story, story_baseinfos, story_outlines
from src.emergence.config import THEMES, MOTIFS


_FILENAME = "emergence.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The red emergence project")
