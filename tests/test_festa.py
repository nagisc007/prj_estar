# -*- coding: utf-8 -*-
"""Test: The night festa
"""
import unittest
from storybuilder.builder import testutils as utl
from src.festa.story import world, story, story_baseinfos, story_outlines
from src.festa.config import THEMES, MOTIFS


_FILENAME = "festa.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The night festa project")
