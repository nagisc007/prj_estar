# -*- coding: utf-8 -*-
"""Test: The forbidden love
"""
import unittest
from storybuilder.builder import testutils as utl
from src.forbidden.story import world, story, story_baseinfos, story_outlines
from src.forbidden.config import THEMES, MOTIFS


_FILENAME = "forbidden.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The forbidden love project")
