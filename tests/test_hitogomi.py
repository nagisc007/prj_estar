...
from src.hitogomi.story import world, story, story_baseinfos, story_outlines
from src.hitogomi.config import THEMES, MOTIFS


_FILENAME = "hitogomi.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The hitogomi project")
