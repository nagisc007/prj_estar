...
from src.hiyari.story import world, story, story_baseinfos, story_outlines
from src.hiyari.config import THEMES, MOTIFS


_FILENAME = "hiyari.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The cold town project")
