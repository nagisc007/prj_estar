...
from src.letter.story import world, story, story_baseinfos, story_outlines
from src.letter.config import THEMES, MOTIFS


_FILENAME = "letter.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The letter")
