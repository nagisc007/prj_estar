...
from src.moonlight.story import world, story, story_baseinfos, story_outlines
from src.moonlight.config import THEMES, MOTIFS


_FILENAME = "moonlight.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The girl hearing a moonlight")
