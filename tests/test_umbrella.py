# -*- coding: utf-8 -*-
"""Test: The night umbrella
"""
import unittest
from storybuilder.builder import testutils as utl
from src.umbrella.story import world, story, story_baseinfos, story_outlines
from src.umbrella.config import THEMES, MOTIFS


_FILENAME = "umbrella.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The night umbrella project")
