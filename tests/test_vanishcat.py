...
from src.vanishcat.story import world, story, story_baseinfos, story_outlines
from src.vanishcat.config import THEMES, MOTIFS


_FILENAME = "vanishcat.story.py"
...
class StoryTest(unittest.TestCase):
    ...
    @classmethod
    def setUpClass(cls):
        utl.print_test_title(_FILENAME, "The vanish cat project")
